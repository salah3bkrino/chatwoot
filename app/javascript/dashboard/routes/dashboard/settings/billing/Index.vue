...
<template>
  <SettingsLayout
    :is-loading="
      ...
      (isWaitingForBilling && isOnChatwootCloud) ||
      (!hasABillingPlan && isOnChatwootCloud)
    "
    :loading-message="
      isWaitingForBilling
    ...
    "
    :no-records-found="
      !isOnChatwootCloud && !currencySelectionRequired && !hasABillingPlan && !isWaitingForBilling
    "
  ...
  >
    ...
    <template #body>
      ...
      <section v-else-if="currencySelectionRequired" class="grid gap-4">
        <BillingCard
