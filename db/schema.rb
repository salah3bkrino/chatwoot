...
ActiveRecord::Schema[7.1].define(version: 2026_07_18_000000) do
  ...
  create_table "accounts", id: :serial, force: :cascade do |t|
    ...
    t.index ["subscription_end_date"], name: "index_accounts_on_subscription_end_date"
    t.index ["subscription_plan_id"], name: "index_accounts_on_subscription_plan_id"
  ...
  create_table "manual_payment_requests", force: :cascade do |t|
    t.bigint "account_id", null: false
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id"], name: "index_manual_payment_requests_on_account_id"
    t.index ["approved_by_id"], name: "index_manual_payment_requests_on_approved_by_id"
    t.index ["status"], name: "index_manual_payment_requests_on_status"
    t.index ["subscription_plan_id"], name: "index_manual_payment_requests_on_subscription_plan_id"
  end
  ...
  create_table "subscription_plans", force: :cascade do |t|
    ...
    t.integer "max_agents", default: 3, null: false
    t.integer "max_inboxes", default: 5, null: false
  ...
  add_foreign_key "accounts", "subscription_plans"
  add_foreign_key "manual_payment_requests", "accounts"
  add_foreign_key "manual_payment_requests", "subscription_plans"
  add_foreign_key "manual_payment_requests", "users", column: "approved_by_id"
